...
LEVEL_REWARDS: Dict[int, Dict[str, Any]] = {
    0: {  # 新手關卡
        ...
        "speed_bonus": [
            {"threshold": 120, "gold": 500, "souls": 100, "bonus_name": "★★★ Perfect Clear!"},
            {"threshold": 180, "gold": 300, "souls": 60, "bonus_name": "★★ Speed Clear!"},
            {"threshold": 240, "gold": 150, "souls": 30, "bonus_name": "★ Fast Clear"},
        ]
    },
    1: {
        "first_clear": [
        ...
        "speed_bonus": [
            {"threshold": 180, "gold": 800, "souls": 150, "bonus_name": "★★★ Master Clear!"},
            {"threshold": 240, "gold": 400, "souls": 80, "bonus_name": "★★ Speed Clear!"},
            {"threshold": 300, "gold": 200, "souls": 50, "bonus_name": "★ Fast Clear"},
        ]
    },
    2: {
        "first_clear": [
        ...
        "speed_bonus": [
            {"threshold": 240, "gold": 1000, "souls": 200, "bonus_name": "★★★ Insane Speed!"},
            {"threshold": 300, "gold": 500, "souls": 100, "bonus_name": "★★ Speed Clear!"},
            {"threshold": 360, "gold": 250, "souls": 60, "bonus_name": "★ Fast Clear"},
        ]
    },
    3: {
        "first_clear": [
        ...
        "speed_bonus": [
            {"threshold": 300, "gold": 1500, "souls": 300, "bonus_name": "★★★ Godlike Clear!"},
            {"threshold": 360, "gold": 700, "souls": 150, "bonus_name": "★★ Speed Clear!"},
            {"threshold": 480, "gold": 350, "souls": 80, "bonus_name": "★ Fast Clear"},
        ]
    },
    4: {  # 最終關卡
        "first_clear": [
        ...
        "speed_bonus": [
            {"threshold": 360, "gold": 5000, "souls": 1000, "bonus_name": "★★★ Legendary Speed!"},
            {"threshold": 480, "gold": 2000, "souls": 400, "bonus_name": "★★ Extreme Clear!"},
            {"threshold": 600, "gold": 800, "souls": 200, "bonus_name": "★ Speed Clear"},
        ]
    }
}
